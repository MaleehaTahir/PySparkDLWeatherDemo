...
logging.basicConfig(level=logging.DEBUG, filename='../resources/logging/weatherloggingFailure.txt', filemode='w')
...
class SparkDfTest(PySparkTest):
    ...
    def test_data_frame(self):
        ...
        csv_file_list = ["../resources/sourceFiles/weather.20160201.csv",
                         "../resources/sourceFiles/weather.20160301.csv"]

        df_list = []
        for file in csv_file_list:
            df_list.append(pd.read_csv(os.path.relpath(file)))  # pandas df to read csv files
